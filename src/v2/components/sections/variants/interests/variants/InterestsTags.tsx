/**
 * Interests Tags Variant
 *
 * Rectangular tags with left accent border and light tinted background.
 */
...
export const InterestsTags: React.FC<InterestsVariantProps> = ({
  items,
  config,
  accentColor,
  editable = false,
    ...
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', alignItems: 'center' }}>
      ...
      {editable && onAddInterest && (
        <button
          ...
          className="flex items-center gap-1 text-xs px-2.5 py-0.5 rounded border border-dashed hover:bg-gray-50 transition-colors"
