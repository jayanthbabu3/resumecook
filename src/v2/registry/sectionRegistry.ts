...
export const SECTION_REGISTRY: Record<V2SectionType, SectionDefinition> = {
  ...
  experience: {
    ...
    formFields: [
      ...
      { key: 'description', label: 'Role Overview', type: 'textarea', rows: 2, placeholder: 'Brief overview of your role and key responsibilities...', fullWidth: true },
      { key: 'bulletPoints', label: 'Responsibilities & Impact', type: 'array', placeholder: 'Add responsibility or achievement...' },
    ],
    variants: [
      { id: 'standard', name: 'Standard', description: 'Classic corporate layout' },
      { id: 'compact', name: 'Compact', description: 'Space-efficient single line' },
      { id: 'timeline', name: 'Timeline', description: 'Visual timeline with dots' },
      { id: 'cards', name: 'Cards', description: 'Card-based layout' },
      { id: 'minimal', name: 'Minimal', description: 'Ultra-minimal text only' },
      { id: 'modern', name: 'Modern', description: 'Modern with accent borders' },
      { id: 'enhanced', name: 'Enhanced', description: 'Production-ready style' },
      { id: 'timeline-pro', name: 'Timeline Pro', description: 'Milestone timeline with date rail' },
      { id: 'icon-accent', name: 'Icon Accent', description: 'Carded layout with icon column' },
      { id: 'icon-clean', name: 'Icon Clean', description: 'Lean row with icon and inline meta' },
      { id: 'dots-timeline', name: 'Dots Timeline', description: 'Connected dots timeline' },
    ],
    defaultVariant: 'standard',
  ...
  education: {
    ...
    variants: [
      { id: 'standard', name: 'Standard', description: 'Classic layout with details' },
      { id: 'compact', name: 'Compact', description: 'Space-efficient single line' },
      { id: 'detailed', name: 'Detailed', description: 'Full details with GPA' },
      { id: 'timeline', name: 'Timeline', description: 'Visual timeline with dots' },
      { id: 'cards', name: 'Cards', description: 'Card-based layout' },
      { id: 'minimal', name: 'Minimal', description: 'Ultra-minimal text only' },
      { id: 'academic', name: 'Academic', description: 'Academic CV style' },
      { id: 'modern', name: 'Modern', description: 'Modern with accent styling' },
    ],
    defaultVariant: 'standard',
    allowMultiple: true,
    minItems: 0,
  ...
  skills: {
    ...
    variants: [
      ...
      { id: 'category-lines', name: 'Category Lines', description: 'Category headers with skills' },
      { id: 'bordered-tags', name: 'Bordered Tags', description: 'Bordered rectangular tags' },
      { id: 'pills-accent', name: 'Pills Accent', description: 'Accent-colored pills' },
      { id: 'inline-dots', name: 'Inline Dots', description: 'Inline with dot separators' },
      { id: 'boxed', name: 'Boxed', description: 'Stacked bordered boxes' },
      { id: 'compact', name: 'Compact', description: 'Compact single line' },
      { id: 'modern', name: 'Modern', description: 'Modern cards with icons' },
    ],
  ...
  languages: {
    ...
    variants: [
      { id: 'standard', name: 'Standard', description: 'Standard list format' },
      ...
      { id: 'compact', name: 'Compact', description: 'Compact layout' },
      { id: 'flags', name: 'Flags', description: 'With country flags' },
    ],
    defaultVariant: 'list',
    allowMultiple: true,
    minItems: 0,
  ...
  achievements: {
    ...
    variants: [
      ...
      { id: 'metrics', name: 'Metrics', description: 'With metrics emphasis' },
      { id: 'boxed', name: 'Boxed', description: 'Stacked bordered boxes' },
    ],
    defaultVariant: 'list',
    allowMultiple: true,
  ...
  certifications: {
    ...
    variants: [
      ...
      { id: 'badges', name: 'Badges', description: 'Badge style' },
      { id: 'timeline', name: 'Timeline', description: 'Timeline style' },
      { id: 'detailed', name: 'Detailed', description: 'Full details' },
      { id: 'grouped', name: 'Grouped', description: 'Grouped by issuer' },
    ],
    defaultVariant: 'list',
    allowMultiple: true,
    minItems: 0,
  ...
  projects: {
    ...
    variants: [
      { id: 'standard', name: 'Standard', description: 'Classic layout with description' },
      { id: 'cards', name: 'Cards', description: 'Card-based grid layout' },
      { id: 'compact', name: 'Compact', description: 'Space-efficient layout' },
      { id: 'grid', name: 'Grid', description: 'Grid layout' },
      { id: 'timeline', name: 'Timeline', description: 'Timeline with dates' },
      { id: 'showcase', name: 'Showcase', description: 'Portfolio showcase style' },
      { id: 'minimal', name: 'Minimal', description: 'Ultra-minimal' },
      { id: 'detailed', name: 'Detailed', description: 'Full details with highlights' },
    ],
    defaultVariant: 'standard',
    allowMultiple: true,
    minItems: 0,
