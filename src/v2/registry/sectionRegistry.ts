...
export const SECTION_REGISTRY: Record<V2SectionType, SectionDefinition> = {
  ...
  experience: {
    ...
    variants: [
      ...
      { id: 'timeline-pro', name: 'Timeline Pro', description: 'Professional timeline' },
      { id: 'icon-accent', name: 'Icon Accent', description: 'Card with company icon' },
      { id: 'icon-clean', name: 'Icon Clean', description: 'Clean with circular icon' },
