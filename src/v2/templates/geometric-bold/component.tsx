/**
 * Geometric Bold Template Component
 *
 * Bold creative resume with angular geometric shapes,
 * diamond icons, and strong visual hierarchy.
 */
...
const GeometricBoldContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const GeometricBoldTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <GeometricBoldContent {...props} />
    </BaseTemplateProvider>
  );
};
