/**
 * Paper Fold Template Component
 *
 * Elegant asymmetric design with corner fold
 * decoration and split layout.
 */
...
const PaperFoldContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const PaperFoldTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <PaperFoldContent {...props} />
    </BaseTemplateProvider>
  );
};
