/**
 * Impact Leader Template Component
 *
 * A modern, ATS-friendly single-column layout with:
 * - Bold header with teal accent bar
...
const ImpactLeaderContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const ImpactLeaderTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <ImpactLeaderContent {...props} />
    </BaseTemplateProvider>
  );
};
