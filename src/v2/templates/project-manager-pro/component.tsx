/**
 * Project Manager Pro Template Component
 *
 * Clean professional single-column layout with left accent bar.
 * Features serif name, boxed contact icons, summary section,
 * work experience with company icons, and bordered skill tags.
 *
 * Note: Left accent bar decoration is handled by ResumeRenderer
...
const ProjectManagerProContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
  ...
  // Page padding - extra left padding for accent bar
  ...
  return (
    <div style={containerStyle}>
      <div style={contentStyle}>
        {/* Header - Name, Title, Contact Boxes */}
        <HeaderSection
...
export const ProjectManagerProTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <ProjectManagerProContent {...props} />
    </BaseTemplateProvider>
  );
};
