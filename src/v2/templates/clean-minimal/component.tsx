/**
 * Clean Minimal Template Component
 *
 * Ultra-clean minimal resume with maximum whitespace
 * and readability.
 */
...
const CleanMinimalContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const CleanMinimalTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <CleanMinimalContent {...props} />
    </BaseTemplateProvider>
  );
};
