/**
 * Dot Grid Template Component
 *
 * Modern minimal design with subtle dot grid pattern accent
...
const DotGridContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const DotGridTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <DotGridContent {...props} />
    </BaseTemplateProvider>
  );
};
