/**
 * DevOps Command Template Component
 *
...
const DevopsCommandContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const DevopsCommandTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <DevopsCommandContent {...props} />
    </BaseTemplateProvider>
  );
};
