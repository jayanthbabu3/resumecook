/**
 * Ink Blot Template Component
 *
 * Modern minimal design with circular accent blob
...
const InkBlotContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const InkBlotTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <InkBlotContent {...props} />
    </BaseTemplateProvider>
  );
};
