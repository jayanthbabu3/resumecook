/**
 * Modern Elegance Template Component
 *
 * Sophisticated modern resume with elegant typography,
 * centered header with accent underline, and refined design.
 */
...
const ModernEleganceContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
  ...
  return (
    <div style={containerStyle}>
      <div style={contentStyle}>
        {/* Header - Centered with accent underline */}
        <HeaderSection
...
export const ModernEleganceTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <ModernEleganceContent {...props} />
    </BaseTemplateProvider>
  );
};
