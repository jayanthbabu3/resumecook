/**
 * Line Accent Template Component
 *
 * Clean design with full-width accent lines
 * and asymmetric elegant layout.
 */
...
const LineAccentContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const LineAccentTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <LineAccentContent {...props} />
    </BaseTemplateProvider>
  );
};
