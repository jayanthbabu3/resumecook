/**
 * Refined Serif Template Component
 *
 * Elegant serif typography with thin line separators
 * and classic sophisticated aesthetic.
 */
...
const RefinedSerifContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const RefinedSerifTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <RefinedSerifContent {...props} />
    </BaseTemplateProvider>
  );
};
