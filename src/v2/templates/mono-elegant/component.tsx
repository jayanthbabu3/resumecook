/**
 * Mono Elegant Template Component
 *
 * Monospace typography with elegant spacing
...
const MonoElegantContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const MonoElegantTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <MonoElegantContent {...props} />
    </BaseTemplateProvider>
  );
};
