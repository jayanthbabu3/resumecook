/**
 * Minimal Edge Template Component
 *
 * Ultra-clean design with sharp geometric accents
 * and modern split contact layout.
 */
...
const MinimalEdgeContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const MinimalEdgeTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <MinimalEdgeContent {...props} />
    </BaseTemplateProvider>
  );
};
