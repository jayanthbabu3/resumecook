/**
 * CIO Executive Template Component
 *
 * A professional executive layout with:
 * - Photo left, name/title/summary right
 * - Gray contact bar with icons
 * - Two-column body: Work Experience & Education (left), Skills & Certifications (right)
...
const CIOExecutiveContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const CIOExecutiveTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <CIOExecutiveContent {...props} />
    </BaseTemplateProvider>
  );
};

export default CIOExecutiveTemplate;
