/**
 * CIO Executive Template Mock Data
 *
...
export const cioExecutiveMockData: ResumeData = {
  personalInfo: {
  ...
  summary:
    'Lead Mobile Software Engineer with 8+ years of experience in native and cross-platform mobile development, leveraging expertise in React, Angular, and NodeJs to deliver scalable and robust solutions. Proven track record of driving technical initiatives, collaborating with cross-functional teams, and mentoring junior engineers. Passionate about adopting modern software engineering practices, including Agile methodologies and DevSecOps, to drive continuous improvement and innovation.',
  experience: [
    {
      id: 'exp-1',
      company: 'ServiceNow',
  ...
  interests: [
    ...
    { id: 'int-3', name: 'Mobile Development' },
    { id: 'int-4', name: 'Cloud Technologies' },
  ],
  projects: [
    {
      id: 'proj-1',
      name: 'Team Opinion',
      description: 'Full stack project to play fun game with team members',
    ...
    },
    {
      id: 'proj-2',
      name: 'Talentscreen',
      description: 'Recruitment platform for talent screening',
...
export default cioExecutiveMockData;
