/**
 * Swiss Minimal Template Component
 *
 * Swiss design inspired with bold typography
...
const SwissMinimalContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const SwissMinimalTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <SwissMinimalContent {...props} />
    </BaseTemplateProvider>
  );
};
