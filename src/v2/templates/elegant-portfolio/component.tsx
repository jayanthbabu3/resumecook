/**
 * Elegant Portfolio Template Component
 *
 * Beautiful portfolio-style resume with centered photo
 * and elegant design.
 */
...
const ElegantPortfolioContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
  ...
  return (
    <div style={containerStyle}>
      <div style={contentStyle}>
        {/* Header - Elegant photo card style */}
        <HeaderSection
...
export const ElegantPortfolioTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <ElegantPortfolioContent {...props} />
    </BaseTemplateProvider>
  );
};
