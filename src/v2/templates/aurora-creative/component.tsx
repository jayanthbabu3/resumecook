/**
 * Aurora Creative Template Component
 *
 * Stunning creative resume with aurora borealis-inspired gradient header,
...
const AuroraCreativeContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const AuroraCreativeTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <AuroraCreativeContent {...props} />
    </BaseTemplateProvider>
  );
};
