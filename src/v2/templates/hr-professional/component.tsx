/**
 * HR Professional Template Component
 *
 * A professional HR layout with:
 * - Blue gradient banner header with split contact
 * - Two-column body: Work Experience (left), Skills & Certifications & Education (right)
...
const HRProfessionalContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
  ...
  // Body padding - uses explicit padding for content area
...
export const HRProfessionalTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <HRProfessionalContent {...props} />
    </BaseTemplateProvider>
  );
};
