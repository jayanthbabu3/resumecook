/**
 * Accent Stripe Template Component
 *
 * Modern minimal design with vertical accent stripe
 * and bold typography.
 */
...
const AccentStripeContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
...
export const AccentStripeTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <AccentStripeContent {...props} />
    </BaseTemplateProvider>
  );
};
