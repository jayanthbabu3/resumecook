/**
 * Creative Starter Template Component
 *
 * Modern creative resume with vibrant gradient header,
 * decorative shapes, and profile photo support.
 */
...
const CreativeStarterContent: React.FC<Omit<TemplateComponentProps, 'config'>> = (props) => {
  ...
  // Page padding - note: top is 0 because header extends to edge
  ...
  return (
    <div style={containerStyle}>
      <div style={contentStyle}>
        {/* Header - Gradient with shapes and photo */}
        <HeaderSection
...
export const CreativeStarterTemplate: React.FC<TemplateComponentProps> = (props) => {
  return (
    <BaseTemplateProvider {...props}>
      <CreativeStarterContent {...props} />
    </BaseTemplateProvider>
  );
};
