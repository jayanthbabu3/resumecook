...
export const professionalBlueConfig: TemplateConfig = createTemplateConfig({
  ...
  sections: [
    ...
    { type: 'publications', id: 'publications', title: 'Publications', defaultTitle: 'Publications', enabled: false, order: 7, column: 'main' },
    { type: 'languages', id: 'languages', title: 'Languages', defaultTitle: 'Languages', enabled: false, order: 8, column: 'main' },
    { type: 'awards', id: 'awards', title: 'Awards', defaultTitle: 'Awards', enabled: false, order: 9, column: 'main' },
    { type: 'volunteer', id: 'volunteer', title: 'Volunteer Experience', defaultTitle: 'Volunteer Experience', enabled: false, order: 10, column: 'main' },
    { type: 'interests', id: 'interests', title: 'Interests', defaultTitle: 'Interests', enabled: false, order: 11, column: 'main' },
  ],
