 ...
 *
 * Two-column layout with strong typography and technical focus.
 */
...
export const backendPrecisionConfig: TemplateConfig = createTemplateConfig({
  ...
  description: 'Two-column layout with technical focus for backend engineers.',
  ...
  sections: [
    ...
    { type: 'achievements', id: 'achievements', title: 'Highlights', defaultTitle: 'Highlights', enabled: true, order: 4, column: 'sidebar' },
  ],
