 ...
 * Focus on Education, Projects, Skills, and Achievements.
 * Minimal experience section for internships.
 */
...
export const fresherStarterConfig: TemplateConfig = createTemplateConfig({
  ...
  description: 'Clean single-column layout perfect for fresh graduates with focus on education and projects',
