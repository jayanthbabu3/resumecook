      ...
      <div className="relative p-10 mb-6" style={{ backgroundColor: `${themeColor}05` }}>
        ...
        <div className="text-center pt-4">
          ...
          <div className="flex justify-center items-center gap-3 text-sm flex-wrap">
            <InlineEditableText text={personalInfo.email} editable={editable} field="personalInfo.email" className="px-3 py-1 bg-white rounded" />
            <InlineEditableText text={personalInfo.phone} editable={editable} field="personalInfo.phone" className="px-3 py-1 bg-white rounded" />
            {personalInfo.location && (
              <InlineEditableText text={personalInfo.location} editable={editable} field="personalInfo.location" className="px-3 py-1 bg-white rounded" />
            )}
          </div>
        </div>
      </div>
